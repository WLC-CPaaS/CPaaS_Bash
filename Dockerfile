...
# Setup prompt
#
RUN echo 'export PS1="[White Label Communications CPaas API Documentation] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[White Label Communications CPaas API Documentation] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)White Label Communications CPaas API Documentation$(tput sgr0).\n\
\n\
